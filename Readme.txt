...
This is an archive of Python scripts accompanying the paper. It contains all codes for result replication, as well as a script
enabling easy application of the method.

## Directory Structure

\bounding_performance_measures
  \Graphs - destination folders for all figures
  replication_code.py - script for reproducing results in the paper
  calculator.py - application script
